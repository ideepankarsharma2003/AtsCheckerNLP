...
def run():
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <a href="https://lalitsingh.000.pe" style="text-decoration: none; color: grey;">Lalit Singh </a> 
        </p>
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'mca@123':
                ...
                st.success("Welcome L4lit🔥! Total %d " % values + " User's Have Used Our Tool : )")                
